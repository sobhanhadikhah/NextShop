function InputPercent({ field, form, label,type,disabled }) {
  ...
  return (
    <div className="col-span-12 w-full  flex flex-col gap-2 justify-center " >
            ...
            name={name}
            {...field}
               className="rounded-md border-none text-lg bg-gray-100 focus:outline-red-500 focus:border-none focus:ring-0 "  />
